 ...
 * @version $Id: lang.uspsr.php 2026-02-27 retched Version 1.8.4 $
****************************************************************************
...
$define = [
    ...
    'MODULE_SHIPPING_USPSR_ERROR_BAD_ORIGIN_ZIPCODE' => MODULE_SHIPPING_USPSR_ERROR . 'An invalid shipment origin ZIP code has been detected. Please enter a valid ZIP Code in the <a href="' . zen_href_link(FILENAME_DEFAULT, "cmd=configuration&gID=7&cID=211&action=edit") .'">Configuration > Shipping/Package > Postal Code</a> config setting.',
    'MODULE_SHIPPING_USPSR_ERROR_BAD_ORIGIN_COUNTRY' => MODULE_SHIPPING_USPSR_ERROR . 'USPS can only ship from USA, but your store is configured with another country as its origin! See <a href="' . zen_href_link(FILENAME_DEFAULT, "cmd=configuration&gID=7&cID=210&action=edit") . '">Admin > Configuration > Shipping/Packaging > Country of Origin</a>.',
    'MODULE_SHIPPING_USPSR_ERROR_BAD_CREDENTIALS' => MODULE_SHIPPING_USPSR_ERROR . 'You didn\'t enter the API Key and Secret. Please follow the instructions and log in to the developers dashboard to obtain your Consumer Secret and Consumer Key.',
    'MODULE_SHIPPING_USPSR_ERROR_NO_CREDENTIALS' => MODULE_SHIPPING_USPSR_ERROR . 'You didn\'t enter an API Key and Secret. Please follow the instructions and log in to the developers dashboard to obtain your Consumer Secret and Consumer Key.',
    'MODULE_SHIPPING_USPSR_ERROR_NO_CONTRACT' => MODULE_SHIPPING_USPSR_ERROR . 'You chose to have Contract pricing but you entered invalid Account details. Check your settings.',
    'MODULE_SHIPPING_USPSR_ERROR_REJECTED_CREDENTIALS' => MODULE_SHIPPING_USPSR_ERROR . 'Unable to obtain bearer token. Check to make sure that you entered valid API Credentials and that those credentials have permission to access the API. Check your settings.',
    'MODULE_SHIPPING_USPSR_ERROR_NO_UPGRADE' => MODULE_SHIPPING_USPSR_ERROR . "You are using the repository version (0.0.0) of USPSr, you <strong>CANNOT</strong> upgrade this version directly. You must uninstall and reinstall the module to apply any upgrade.",

    'MODULE_SHIPPING_USPSR_UPGRADE_SUCCESS' => MODULE_SHIPPING_USPSR_NOTICE . "Success! The USPSr module has been updated to version <code>%s</code> .",
    ...
    'MODULE_SHIPPING_USPSR_WARNING_LOW_ACCESS' => MODULE_SHIPPING_USPSR_NOTICE . 'Your API credentials only have [Public Access I] or [Public Access] permissions. This is the lowest level of access and may cause you to have <code>429 - Too Many Requests</code> errors. If you start noticing USPS rates are not being returned, please consider <a href="https://github.com/retched/ZC-USPSRestful/wiki/Requesting-a-higher-quota-threshold" target="_blank">putting in a request for more API calls</a>.',
