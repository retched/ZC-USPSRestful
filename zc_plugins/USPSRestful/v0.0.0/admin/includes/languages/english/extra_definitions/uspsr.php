...
define('MODULE_SHIPPING_USPSR_ERROR_BAD_ORIGIN_COUNTRY' , MODULE_SHIPPING_USPSR_ERROR . 'USPS can only ship from USA, but your store is configured with another country as its origin! See <a href="http://localhost.com/zencart2/admin/index.php?cmd=configuration&gID=7&cID=210&action=edit">Admin > Configuration > Shipping/Packaging > Country of Origin</a>.');
