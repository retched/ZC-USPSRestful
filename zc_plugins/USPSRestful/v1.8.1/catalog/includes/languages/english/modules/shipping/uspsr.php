 ...
 * @version $Id: uspsr.php 2026-02-21 retched Version 1.8.1 $
****************************************************************************
...
define('MODULE_SHIPPING_USPSR_TEXT_TITLE' , 'United States Postal Service');
define('MODULE_SHIPPING_USPSR_TEXT_SHORT_TITLE' , 'USPS');
define('MODULE_SHIPPING_USPSR_TEXT_TITLE_ADMIN' , 'United States Postal Service (RESTful)');
define('MODULE_SHIPPING_USPSR_TEXT_DESCRIPTION' , '<strong>United States Postal Service</strong> (RESTful)<br><br>You will need to have registered an account with USPS and API credentials made at <a href="https://cop.usps.com/" target="_blank">https://cop.usps.com/</a> to use this module.<br><br>You <strong>CANNOT</strong> use your WebTools API Credentials with this module! You must obtain your credentials by creating a USPS.com account, if you don\'t have one already. If you\'re making a new account, make a <strong>BUSINESS</strong> account. The APIs might not work as well with a Personal Account. You can find the full <a href="https://github.com/retched/ZC-USPSRestful/wiki/Getting-Started#obtaining-credentials-from-usps" target="_blank">steps to make credentials</a> on the repository\'s site.<br><br>USPS expects you to use pounds as the weight measure for your products. <em>This module will convert all metric measurements to imperial if you configured the site to use metric.</em>');

define('MODULE_SHIPPING_USPSR_TEXT_SERVER_ERROR' , 'An error occurred in obtaining USPS shipping quotes.<br>If you prefer to use USPS as your shipping method, please try refreshing this page, or <a target="_blank" href="' . zen_href_link(FILENAME_CONTACT_US) . '">contact the store owner</a>. If the error persists, please contact us and provide the following error(s):');
define('MODULE_SHIPPING_USPSR_TEXT_ERROR' , 'We are unable to find a USPS shipping quote suitable for your mailing address and the shipping methods we typically use.<br><br>If you prefer to use USPS as your shipping method, please <a target="_blank" href="' . zen_href_link(FILENAME_CONTACT_US) . '">contact us</a> for assistance. (Please check that your Zip/Postal Code is entered correctly.)');
