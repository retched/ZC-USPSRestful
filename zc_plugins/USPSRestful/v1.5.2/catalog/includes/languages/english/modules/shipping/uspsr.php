 ...
 * @version $Id: uspsr.php 2025-10-19 retched Version 1.5.2 $
****************************************************************************
...
define('MODULE_SHIPPING_USPSR_TEXT_SERVER_ERROR' , 'An error occurred in obtaining USPS shipping quotes.<br>If you prefer to use USPS as your shipping method, please try refreshing this page, or contact the store owner. If the error persists, please contact us and provide the following error(s):');
