...
![ZC-USPSRestful](https://socialify.git.ci/retched/ZC-USPSRestful/image?custom_description=A%20USPS%20shipping%20module%20for%20ZenCart%20for%20PHP%207.1%2B%20%2F%20PHP%208&description=1&font=Inter&forks=1&issues=1&language=1&name=1&owner=0&pattern=Signal&pulls=1&stargazers=1&theme=Auto)
...
- Latest Release: [1.8.6](https://github.com/retched/ZC-USPSRestful/releases/latest)  
  _Released September 22, 2026 for ZenCart 1.5.5, 1.5.6, 1.5.7, 1.5.8, 2.0.x, 2.1.0, 2.2.x._  

### Version/Release History

- 1.8.6 [Download](https://github.com/retched/ZC-USPSRestful/releases/tag/v1.8.6)  
  Minor bug fixes to squelch an undefined constant error. Fixed zipcode listing to actually be zip and space separated. (Also added ranges.) Fixed a potential issue that could have the cart show $0.00 as the price unknowingly if the API fails to return.
...
- \zc_plugins\USPSRestful\v1.8.6\admin\uspsr_purge.php
- \zc_plugins\USPSRestful\v1.8.6\admin\uspsr_uninstall.php
- \zc_plugins\USPSRestful\v1.8.6\admin\includes\extra_datafiles\uspsr_uninstaller.php
- \zc_plugins\USPSRestful\v1.8.6\admin\includes\functions\extra_functions\usps.extra_functions.php
- \zc_plugins\USPSRestful\v1.8.6\admin\includes\languages\english\extra_definitions\lang.uspsr.php
- \zc_plugins\USPSRestful\v1.8.6\admin\includes\languages\english\extra_definitions\uspsr.php
- \zc_plugins\USPSRestful\v1.8.6\catalog\includes\languages\english\modules\shipping\lang.uspsr.php
- \zc_plugins\USPSRestful\v1.8.6\catalog\includes\languages\english\modules\shipping\uspsr.php
- \zc_plugins\USPSRestful\v1.8.6\catalog\includes\functions\extra_functions\usps.extra_functions.php
- \zc_plugins\USPSRestful\v1.8.6\catalog\includes\modules\shipping\uspsr.php
- \zc_plugins\USPSRestful\v1.8.6\catalog\includes\templates\template_default\images\icons\shipping_usps.gif
- \zc_plugins\USPSRestful\v1.8.6\Installer\ScriptedInstaller.php
```
